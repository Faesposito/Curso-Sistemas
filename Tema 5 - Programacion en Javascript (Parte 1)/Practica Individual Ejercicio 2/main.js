...
function AverageRelativeHumidity(WeatherTable) {
    ...
    for (let index = 0; index < WeatherTable.length; index++) {
        averageRelativeHumidity = averageRelativeHumidity + WeatherTable[index].RelativeHumidity;
        counter++;
    }
...
function ShowAveragesTemperaturesAndHumidity(WeatherTable) {
    ...
    console.log("El promedio de Temperatura Maxima es: ", AverageMaxTemperature(WeatherTable));
    console.log("El promedio de Temperatura Minima es: ", AverageMinTemperature(WeatherTable));
    console.log("El promedio de Humedad Relativa es: ", AverageRelativeHumidity(WeatherTable));
