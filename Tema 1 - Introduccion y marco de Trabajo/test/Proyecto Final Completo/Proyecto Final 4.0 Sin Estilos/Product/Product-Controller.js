...
class ProductController {
	...
	onAddToCartClick() {
		...
		productMax = pruductMax- productValue;
		console.log(productValue);
		let html = `<input type="number" id="product-quantity${productIndex}" name="quantity" min="0" max="${productMax}" value="1">`

		document.getElementById('product-quantity-div' + productIndex).innerHTML = '';
